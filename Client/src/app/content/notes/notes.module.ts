...
import { HtmlDotListComponent } from './full-note/full-note-components/html-components/html-dot-list/html-dot-list.component';
import { HtmlHeadingsComponent } from './full-note/full-note-components/html-components/html-headings/html-headings.component';
import { HtmlCheckListComponent } from './full-note/full-note-components/html-components/html-check-list/html-check-list.component';
...
import { PhotoComponent } from './full-note/full-note-components/photo/photo.component';
...
import { HtmlLinkComponent } from './full-note/full-note-components/html-components/html-link/html-link.component';
import { HistoryRecordComponent } from './full-note/full-note-components/history-record/history-record.component';
import { AudioNoteComponent } from './full-note/full-note-components/audio-note/audio-note.component';
import { VideoNoteComponent } from './full-note/full-note-components/video-note/video-note.component';
import { DocumentNoteComponent } from './full-note/full-note-components/document-note/document-note.component';
import { AudioComponent } from './full-note/full-note-components/audio/audio.component';
