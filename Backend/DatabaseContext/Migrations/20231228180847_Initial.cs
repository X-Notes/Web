        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    Metadata = table.Column<string>(type: "jsonb", maxLength: 1000, nullable: true),
                    Contents = table.Column<string>(type: "jsonb", maxLength: 12000, nullable: true),
                    PlainContent = table.Column<string>(type: "character varying(5000)", maxLength: 5000, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    NoteId = table.Column<Guid>(type: "uuid", nullable: false),
                    UsersThatEditIds = table.Column<string>(type: "jsonb", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    AppFileId = table.Column<Guid>(type: "uuid", nullable: false),
                    BaseNoteContentId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CollectionNoteAppFile", x => new { x.BaseNoteContentId, x.AppFileId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TextNoteIndex", x => x.BaseNoteContentId);
                    table.ForeignKey(
